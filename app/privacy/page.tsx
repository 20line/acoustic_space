          ...
          <div className="prose max-w-none space-y-8" style={{ color: 'var(--ink)' }}>
            ...
            <section>
              ...
              <p className="mt-3 text-[14px]" style={{ color: 'var(--muted)' }}>
                ...
                платёжных систем (ЮKassa), служб доставки и транспортных компаний, непосредственно
                участвующих в выполнении заказа. Для оперативного уведомления менеджера о новой
                заявке её содержание (имя, телефон, состав заказа) передаётся в сервис мессенджера
                Telegram.
              </p>
              <p className="mt-3 text-[14px]" style={{ color: 'var(--muted)' }}>
                Отдельное согласие на обработку персональных данных вы даёте при отправке любой формы
                на сайте — его полный текст доступен на странице{' '}
                <a href="/consent" className="underline underline-offset-2 hover:text-accent">
            ...
            <section>
              ...
              <p className="text-[14px] leading-relaxed" style={{ color: 'var(--muted)' }}>
                ...
                корректно, поэтому они устанавливаются всегда.
              </p>
              <p className="mt-3 text-[14px] leading-relaxed" style={{ color: 'var(--muted)' }}>
                Аналитические cookie сервиса веб-аналитики Яндекс.Метрика (ООО «Яндекс») подключаются
                только после того, как вы нажали «Принять все» в баннере о cookie. До получения
                согласия скрипт Яндекс.Метрики не загружается. Метрика собирает обезличенные данные
                о действиях пользователей (страницы, клики, источники трафика). Отозвать согласие
                можно, очистив cookie и данные сайта в браузере. Политика обработки данных Яндекса:
                yandex.ru/legal/confidential. Маркетинговые и рекламные cookie не используются.
              </p>
            </section>
