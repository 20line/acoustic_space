        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1fr_1.1fr]">
          ...
          <div>
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              <SocialLink href={process.env.NEXT_PUBLIC_TELEGRAM ?? '#'} label="Telegram">
              ...
              <SocialLink href={process.env.NEXT_PUBLIC_WHATSAPP ?? '#'} label="WhatsApp">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="mt-2 flex flex-col gap-1">
                <a href={process.env.NEXT_PUBLIC_TELEGRAM ?? '#'} className="text-[12px] hover:text-accent" style={{ color: 'var(--muted)' }}>
                  Telegram
                </a>
                <a href={process.env.NEXT_PUBLIC_WHATSAPP ?? '#'} className="text-[12px] hover:text-accent" style={{ color: 'var(--muted)' }}>
                  WhatsApp
                </a>
